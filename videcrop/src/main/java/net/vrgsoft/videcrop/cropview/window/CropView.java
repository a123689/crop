...
//        }
    ...
    private void init(Context context) {
        ...
        mCornerLength = TypedValue.applyDimension(1, 40.0F, displayMetrics);
        mGuidelines = 1;
    }
    ...
    private void drawCorners(Canvas canvas) {
        ...
        float right = Edge.RIGHT.getCoordinate();
        float bottom = Edge.BOTTOM.getCoordinate();
        canvas.drawLine(left, top, left, top + mCornerLength, mCornerPaint);
        canvas.drawLine(left, top, left + mCornerLength, top, mCornerPaint);
        canvas.drawLine(right , top, right, top + mCornerLength, mCornerPaint);
        canvas.drawLine(right, top , right - mCornerLength, top, mCornerPaint);
        canvas.drawLine(left, bottom , left , bottom - mCornerLength, mCornerPaint);
        canvas.drawLine(left, bottom, left + mCornerLength, bottom, mCornerPaint);
        canvas.drawLine(right , bottom , right, bottom - mCornerLength, mCornerPaint);
        canvas.drawLine(right, bottom, right - mCornerLength, bottom, mCornerPaint);
    }
